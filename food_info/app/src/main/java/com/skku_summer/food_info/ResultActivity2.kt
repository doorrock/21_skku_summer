...
//                    granularity = 20f // 값 만큼 라인선 설정
    ...
    private fun setHorChart(categoryAmount : Array<Float>,
        ...
        for(i in 0..7) {
            ...
            colorList.add(ContextCompat.getColor(this@ResultActivity2,
                R.color.chart_green
            ))
            colorList.add(ContextCompat.getColor(this@ResultActivity2,
                R.color.chart_yellow
            ))
            if(items_gram[i] > categoryAmount[i]) colorList.add(ContextCompat.getColor(this@ResultActivity2,
                R.color.chart_red
            ))
            else colorList.add(ContextCompat.getColor(this@ResultActivity2,
                R.color.main_color
            ))
            ...
            val d = BarDataSet(entries, "DataSet")
                .apply {
                    ...
                    setDrawValues(true)
                    colors = colorList
                    valueTextColor = ContextCompat.getColor(this@ResultActivity2,
                        R.color.black
                    )
                    valueTextSize = 10f
                }
